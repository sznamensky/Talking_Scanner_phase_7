...
# -*- coding: utf-8 -*-
#
#  takepic_undist_preproc_ocr_v1_2_R1.py
# 13 06 2025
# The program takes the scan image from the camera N 1  (right page)
# The program is using the camera calibration results obtained from calibrate_camera_v2_3.py script
# The program processes the scanned image to compensate for the camera N 1 distortion (right page) 
...
# Command line: python takepic_undist_preproc_ocr_v1_2_R1.py 
...
camera_matrix = np.array([[4.71963967e+03,   0.00000000e+00, 1.37274262e+03],
       [  0.00000000e+00, 4.71397652e+03, 1.11468891e+03],
       [  0.00000000e+00,   0.00000000e+00,   1.00000000e+00]])
# Define the camera distortion coefficients (to be imported from the calibration script results)
dist_coefs = np. array([ -1.23886315e+00, 3.40088518e+00, -3.64557324e-02, -6.00013275e-03, -1.22299607e+01])
